        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <!-- Message "edited" which appears if the chirp created at is different from updated one. -->
                    <small
                ...
                <!-- Dropdown with appear only if the current user ID is the same the chirp author's. -->
            ...
            <!-- Edit form which appears only if "editing" variable is set to true, which value is set to true in dropdown -->
            <form
                v-if="editing"
                @submit.prevent="
            ...
            <!-- Chirp message which appears only if the variable "editing" is set to false. -->
